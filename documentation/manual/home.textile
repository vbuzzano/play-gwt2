h1. <a>Play GWT2 Module Version 1.4</a>

p.  Play GWT2 1.4 provides some classes and commands to simplify the integration of a GWT 2.2.0 Module in a play application. 
...
myApp/app/gwt/firstmodule/server
myApp/app/gwt/firstmodule/server/GreetingServiceImpl.java

p. GreetingService Interface must use annotation @RemoteServiceRelativePath("greet")

p. GreetingServiceImpl.java must implements GWTService and use @GWT2ServicePath("/firstmodule/greet") annotation
