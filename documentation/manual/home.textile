h1. <a>Play GWT2 Module Version 1.7</a>

p.  Play GWT2 1.7 provides some classes and commands to simplify the integration of a GWT 2.2.0 Module in a play application. 
 
This module has been tested with play 1.2 and gwt 2.2.x and 2.3

p. In the version 1.7
