...
p.  Play GWT2 1.8 provides some classes and commands to simplify the integration of a GWT 2.2.0 and GWT 2.3.0 project/Module in a play application. 
 
This module has been tested with play 1.2.3 and gwt 2.2.x and 2.3.0
