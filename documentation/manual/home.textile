h1. <a>Play GWT2 Module Version 1.6</a>

p.  Play GWT2 1.6 provides some classes and commands to simplify the integration of a GWT 2.2.0 Module in a play application. 
 
This module has been tested with play 1.2 and gwt 2.2.0

p. In the version 1.6
...
p. note: myApp is not the name of the gwt2 module, but the name of your application. If you are already into the application folder juste use : play gwt2:create
